...
export const PROCESS_CONFIG = {
  ...
  processPhases: [
    ...
    { col: 3, name: "Project Planning", mdFile: "process-c.md" },
    { col: 4, name: "Requirements", mdFile: "process-d.md" },
    { col: 5, name: "Design", mdFile: "process-e.md" },
    { col: 6, name: "Test", mdFile: "process-f.md" },
    { col: 7, name: "DVT", mdFile: "process-g.md" },
    { col: 8, name: "Productization", mdFile: "process-h.md" },
    { col: 9, name: "Qualification", mdFile: "process-i.md" },
    { col: 10, name: "", mdFile: "process-j.md" },
    { col: 11, name: "", mdFile: "process-k.md" },
    { col: 12, name: "", mdFile: "process-l.md" },
    { col: 13, name: "", mdFile: "process-m.md" },
    { col: 14, name: "", mdFile: "process-n.md" },
    { col: 15, name: "", mdFile: "process-o.md" },
    { col: 16, name: "", mdFile: "process-p.md" },
    { col: 17, name: "", mdFile: "process-q.md" },
    { col: 18, name: "", mdFile: "process-r.md" },
    { col: 19, name: "", mdFile: "process-s.md" },
    { col: 20, name: "", mdFile: "process-t.md" },
    { col: 21, name: "", mdFile: "process-u.md" },
    { col: 22, name: "", mdFile: "process-v.md" },
    { col: 23, name: "", mdFile: "process-w.md" },
    { col: 24, name: "", mdFile: "process-x.md" },
  ],
